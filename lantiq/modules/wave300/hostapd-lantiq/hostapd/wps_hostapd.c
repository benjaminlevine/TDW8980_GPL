...
/* added by wwj for 5g wps setup locked 121214 */
...
static int hostapd_wps_cred_cb(void *ctx, const struct wps_credential *cred)
{
	...
	sendWscCredToCos(0, cred->ssid, cred->key[0], authMode, encrMode);
#endif
				  ...
				  struct wps_event_pwd_auth_fail *data)
{
	...
	/* send msg to cos for locked 5g wps setup */
			...
			const char *pin)
{
	...
	if (hapd->wps == NULL)
	{
		wpa_printf(MSG_DEBUG, "hapd->wps == NULL");
		return -1;
	}
	...
	{
		wpa_printf(MSG_DEBUG, "uuid_str2bin return -1");
		return -1;
	}
