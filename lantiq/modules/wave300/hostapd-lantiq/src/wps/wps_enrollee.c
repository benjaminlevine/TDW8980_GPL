						 ...
						 const struct wpabuf *msg)
{
	...
	case RECV_M8:
		...
		/* Though m8 isn't received, enrollee's encryption message 
		 * has been sent for registrar. We still consider this 
		 * case to be association successfully. by wwj 121224
		 */
		wps->state = SEND_WSC_NACK;
		return WPS_DONE;
		break;
