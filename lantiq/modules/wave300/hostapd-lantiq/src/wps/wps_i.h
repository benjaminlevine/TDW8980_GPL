...
#define WPS_STATUS_PATH 	"/proc/tplink/wps_5G_status"
...
#define WPS_LED_PATH 	"/proc/tplink/led_wps_5g"
#define WPS_LED_OFF     0
#define WPS_LED_ON      1
#define WPS_LED_BLINK   2
#define WPS_LED_INPROGRESS 3
#define WPS_LED_ERROR	4
#define WPS_LED_OVERLAP	5
#define WPS_LED_SUCCESS	6
