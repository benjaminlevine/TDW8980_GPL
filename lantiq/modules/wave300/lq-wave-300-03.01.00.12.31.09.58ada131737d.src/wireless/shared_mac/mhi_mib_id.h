...
/*--------------------------------------------------------------------------
 * Managed Object:  MIB_TTPCOM_PHY_(various)
 *
 * Description:     Control of the TTP 802.11b modem
 *
 * Representation:  various.
 *
 * Access:          rw
 *--------------------------------------------------------------------------*/
#if defined (ENET_CFG_CONTORL_MODEM_CHARACTERISTICS)
#define     MIB_TTPCOM_PHY_TX_POWER         0x1108
#define     MIB_TTPCOM_PHY_RX_GAIN          0x1109
#define     MIB_TTPCOM_PHY_LOCKED_CLOCK     0x110A
#define     MIB_TTPCOM_PHY_AGC_GAIN         0x110B
#define     MIB_TTPCOM_PHY_DAGC_GAIN        0x110C
#endif
/*--------------------------------------------------------------------------
