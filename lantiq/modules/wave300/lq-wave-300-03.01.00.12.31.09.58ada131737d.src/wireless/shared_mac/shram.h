...
/* Override settings for release builds             */
#if defined(PLATFORM_COSIM)
    #define NO_TX_FSDUS                            2
    #define ENET_CFG_SIZE_RX_CIRC_BUF_LOG_2       13
#endif

/* Override settings for module testing */
#if defined (ENET_CFG_MODULE_TEST)
    #define NO_TX_FSDUS                            4
    #define NUM_DAT_INDS                           3
    #define BSS_IND_COUNT                          1
#elif defined (PLATFORM_WIN32X86)
    #define BSS_IND_COUNT                          8
#endif

#if defined(ENET_FPGA_MAC_BORAD)
    /* D.S :In order to Reduce memory Size on FPGA board */
    #define BSS_IND_COUNT                          3
    #define NUM_DAT_REQS                           64
    #define NUM_DAT_INDS                           20

	#if defined(METALINK_BER_METER)  /*<E.Z> fix for aggregation transmission*/
		#define NUM_STATION_DBASE_ENTRIES		   4
		#define AGGR_IND_COUNT					   4
	#else
		#define NUM_STATION_DBASE_ENTRIES		   2
		#define AGGR_IND_COUNT					   2
	#endif
...
/* Override memory sizes for this build Required for the HIM module test and Cardbus sub-system tests. */
#if defined (ENET_INC_TEST_LOOPBACK_MAC)
#define NUM_MAN_INDS                               NUM_MAN_REQS
#ifdef MT_REORDER
#define NUM_DAT_INDS                               40
#else
#define NUM_DAT_INDS                               NUM_DAT_REQS
#endif
#define NUM_MEM_INDS                               2
#endif
...
#define FSDU_SECTION_SIZE      (2304*7*4)
...
#ifdef MTLK_HYPERION3
    #define NO_TX_FSDUS         9    /* Used for allocating FSDU memory pool in shram_fsdu.c */
    #define NO_TX_FSDUS_AC_BK   1
    #define NO_TX_FSDUS_AC_BE   24//<y.s> 10
    #define NO_TX_FSDUS_AC_VI   9
	...
	#define NO_TX_FSDUS_AC_BE   20//<y.s> 10
	#define NO_TX_FSDUS_AC_VI   10
	#define NO_TX_FSDUS_AC_VO   4// <y.s> 10
	#define TOTAL_TX_FSDUS      (NO_TX_FSDUS_AC_BK + NO_TX_FSDUS_AC_BE +NO_TX_FSDUS_AC_VI +NO_TX_FSDUS_AC_VO)
#endif//MTLK_HYPERION3


#endif //!defined(NO_TX_FSDUS)
...
/* Note: module test t1616 and subsystem tests 2301, 2302, 2401 and 2731 depend on the following fixed values */
        ...
        #define NUM_STATION_DBASE_ENTRIES       17 /* 100 reduced due to memory shortage */
        #define NUM_OF_TS                       20
    #else
        #define NUM_STATION_DBASE_ENTRIES       8
        #define NUM_OF_TS                       20
    #endif
#endif
