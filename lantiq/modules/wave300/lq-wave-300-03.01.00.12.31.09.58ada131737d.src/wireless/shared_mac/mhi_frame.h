...
typedef struct _HT_CAPABILITIES_INFO
{
    ...
    uint16  psmp_support                   :1; // The PSMP support field indicates support if set to 1. 
    uint16  STBC_cntr_frame_support        :1; // The STBC Control Frame support field indicates that STBC control frames are supported if set to 1.
...
} __MTLK_PACKED HT_CAPABILITIES_INFO;
