...
typedef int (* mtlk_qos_do_classify_f)(mtlk_buffer_t *skb);
...
int __MTLK_IFUNC mtlk_qos_init (struct mtlk_qos *qos);
void __MTLK_IFUNC mtlk_qos_cleanup (struct mtlk_qos *qos);
...
uint16 __MTLK_IFUNC mtlk_qos_get_ac (struct mtlk_qos *qos, mtlk_buffer_t *pbuf);
