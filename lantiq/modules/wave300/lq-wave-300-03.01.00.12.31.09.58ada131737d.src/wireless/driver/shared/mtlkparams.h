...
#define PRM_SHORT_PREAMBLE                      MTLK_TEXT("ShortPreamble")
#define PRM_QOS                                 MTLK_TEXT("QOS")
#define PRM_TX_ANTENNAS                         MTLK_TEXT("TxAntennas")
#define PRM_RX_ANTENNAS                         MTLK_TEXT("RxAntennas")
#define PRM_SPECTRUM_MODE                       MTLK_TEXT("FortyMHzOpMode")
#define PRM_DATABINS                            MTLK_TEXT("Databins")
#define PRM_TX_POWER                            MTLK_TEXT("TxPower")
#define PRM_ADVANCED_CODING                     MTLK_TEXT("AdvancedCoding")
#define PRM_SHORT_CYCLIC_PREFIX                 MTLK_TEXT("ShortCyclicPrefix")
...
#define PRM_ALGO_CALIBR_MASK                    MTLK_TEXT("AlgoCalibrMask")
#define PRM_FORCE_TPC0                          MTLK_TEXT("ForceTPC0")
#define PRM_FORCE_TPC1                          MTLK_TEXT("ForceTPC1")
#define PRM_FORCE_TPC2                          MTLK_TEXT("ForceTPC2")
#define PRM_TPC_ANT0_PER_FREQ_A_B_2_4GHZ        MTLK_TEXT("TPCAnt0PerFreq_A_B_2_4GHz")
#define PRM_TPC_ANT0_PER_FREQ_A_B_5_2GHZ        MTLK_TEXT("TPCAnt0PerFreq_A_B_5GHz")
#define PRM_TPC_ANT1_PER_FREQ_A_B_2_4GHZ        MTLK_TEXT("TPCAnt1PerFreq_A_B_2_4GHz")
#define PRM_TPC_ANT1_PER_FREQ_A_B_5_2GHZ        MTLK_TEXT("TPCAnt1PerFreq_A_B_5GHz")
#define PRM_USE_LONG_PREAMBLE_FOR_MULTICAST     MTLK_TEXT("UseLongPreambleForMulticast")
#define PRM_SHORT_SLOT_TIME_OPTION_ENABLED      MTLK_TEXT("ShortSlotTimeOptionEnabled")
...
#define PRM_CHANNEL_ANNOUNCEMENT_ENABLED        MTLK_TEXT("ChannelAnnouncementEnable")
...
#define PRM_AP_FORWARDING                       MTLK_TEXT("APforwarding")
#define PRM_WDS_ENABLED	                        MTLK_TEXT("WDSEnabled")
#define PRM_BRIDGE_MODE                         MTLK_TEXT("BridgeMode")
#define PRM_L2NAT_AGING_TIMEOUT                 MTLK_TEXT("L2NATAgingTimeout")
#define PRM_ENABLE_PACK_SCHED                   MTLK_TEXT("EnablePacketScheduler")
...
#define PRM_ACL_MAX_CONNECTIONS               MTLK_TEXT("MaxConnections")
#define PRM_ACL_MODE                          MTLK_TEXT("AclMode")
#define PRM_ACL                               MTLK_TEXT("ACL")

#define PRM_POWER_INCREASE_VS_DUTY_CYCLE      MTLK_TEXT("PowerIncreaseVsDutyCycle")
