...
{ 
  ...
  struct MSG_OBJ* (__MTLK_IFUNC *msg_get_from_pool)(mtlk_handle_t usr_data); /*!< function is called to obtain a free real slot to 
...
typedef struct _mtlk_txmm_data_t
{
  ...
  mtlk_handle_t        wait_data;    /*!< reserved for TXMM module internal usage only */
...
/*! \fn       int mtlk_txmm_init(mtlk_txmm_t                *obj, 
...
*/
int __MTLK_IFUNC
mtlk_txmm_init(mtlk_txmm_t                *obj, 
               const mtlk_txmm_cfg_t      *cfg, 
               const mtlk_txmm_wrap_api_t *api);

/*! \fn       int mtlk_txmm_start(mtlk_txmm_t *obj)
...
*/
int __MTLK_IFUNC
mtlk_txmm_start(mtlk_txmm_t *obj);

/*! \fn       int mtlk_txmm_pump(mtlk_txmm_t* obj, struct MSG_OBJ* pmsg)
...
*/
int __MTLK_IFUNC
mtlk_txmm_pump(mtlk_txmm_t* obj, struct MSG_OBJ* pmsg);

/*! \fn       int mtlk_txmm_on_cfm(mtlk_txmm_t* obj, struct MSG_OBJ* pmsg)
    \brief    CFM handler
...
*/
int __MTLK_IFUNC
mtlk_txmm_on_cfm(mtlk_txmm_t* obj, struct MSG_OBJ* pmsg);

/*! \fn       void mtlk_txmm_stop(mtlk_txmm_t *obj)
...
*/
void __MTLK_IFUNC
mtlk_txmm_stop(mtlk_txmm_t *obj);

/*! \fn       void mtlk_txmm_cleanup(mtlk_txmm_t *obj)
...
*/
void __MTLK_IFUNC
mtlk_txmm_cleanup(mtlk_txmm_t* obj);

/*! \fn       void mtlk_txmm_halt(mtlk_txmm_t *obj)
...
*/
void __MTLK_IFUNC
mtlk_txmm_halt(mtlk_txmm_t* obj);

/*! \fn       BOOL mtlk_txmm_is_running(mtlk_txmm_t *obj)
...
*/
BOOL __MTLK_IFUNC
mtlk_txmm_is_running(mtlk_txmm_t* obj);
...
#define mtlk_txmm_msg_init(msg)                                 \
  _mtlk_txmm_msg_init_objpool((msg), __FILE__, __LINE__)
#endif
