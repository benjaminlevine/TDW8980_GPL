...
#define CPU_STAT_ID_NONE                  -1 /*!<  STAT disabled */
#define CPU_STAT_ID_ISR                    0
#define CPU_STAT_ID_TX_OS                  1
#define CPU_STAT_ID_TX_FWD                 2
#define CPU_STAT_ID_TX_FLUSH               3
#define CPU_STAT_ID_TX_HW                  4
#define CPU_STAT_ID_RX_DAT                 5
#define CPU_STAT_ID_RX_NDAT                6
#define CPU_STAT_ID_RX_EMPTY               7
#define CPU_STAT_ID_RX_HW                  8
#define CPU_STAT_ID_LAST                   9
...
__CPU_STAT_WAIT(uint32 usec_delay)
{
  ...
  while( mtlk_dbg_hres_diff_to_us(now, wait_start) < usec_delay );
}
                ...
                mtlk_dbg_hres_ts_t  *start)
{
  ...
  diff = mtlk_dbg_hres_diff_to_us(now, *start);
