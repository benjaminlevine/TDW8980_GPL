...
# define SYSFS_ARGS_DECL \
    ctl_table *table, int write, struct file *filp, void *usp_buf, size_t *lenp
# define SYSFS_ARGS table, write, filp, usp_buf, lenp
#else
# define SYSFS_ARGS_DECL \
    ctl_table *table, int write, struct file *filp, void __user *usp_buf, \
    size_t *lenp, loff_t *ppos
# define SYSFS_ARGS table, write, filp, usp_buf, lenp, ppos
#endif
...
#define kthread_stop(x) pper_card->stop_thread=1
#define kthread_should_stop() (pper_card->stop_thread)
...
static inline bool mtlk_ipv4_is_multicast(__be32 addr)
{
  return (addr & htonl(0xf0000000)) == htonl(0xe0000000);
}
#else
#define mtlk_ipv4_is_multicast       MULTICAST
#endif

#define mtlk_ipv4_is_local_multicast LOCAL_MCAST

#else

#define mtlk_ipv4_is_multicast       ipv4_is_multicast
#define mtlk_ipv4_is_local_multicast ipv4_is_local_multicast
