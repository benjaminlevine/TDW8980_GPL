...
static __INLINE void *
_kmalloc_tag (size_t size, gfp_t gfp, unsigned int tag, const char* file_name, int line)
{
...
#define kmalloc_tag(size, gfp, tag) _kmalloc_tag((size), (gfp), (tag), __FILE__, __LINE__)
#define kfree_tag(buffer)           _kfree_tag(buffer)

static __INLINE void *
_vmalloc_tag (size_t size, unsigned int tag, const char* file_name, int line)
{
...
#define vmalloc_tag(size, tag)      _vmalloc_tag((size), (tag), __FILE__, __LINE__)
