...
static void sendWlanSwitchToCos(char turn_on)
{	
	CMSG_FD msgFd;	
	CMSG_BUFF msgBuff;
				       ...
				       char *custom)
{
	...
	if (strncmp(custom, "MLME-MICHAELMICFAILURE.indication", 33) == 0) {
        ...
        else if (strncmp(custom, "WLAN_UP",7) == 0) {

			wpa_printf(MSG_INFO, "Button WLAN UP");
			sendWlanSwitchToCos(1);
        }
        else if (strncmp(custom, "WLAN_DOWN",9) == 0) {

			wpa_printf(MSG_INFO, "Button WLAN DOWN");
			sendWlanSwitchToCos(0);
        }
        #endif  /* EAP_WPS */
}
