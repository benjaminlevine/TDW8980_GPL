...
static int clip_encap(struct atm_vcc *vcc, int mode)
{
	...
	if ( ppa_hook_mpoa_setup )	/* wzy: mpoa_setup(), 10Aug12 */
    {
		/* printk("clip_mkip(): ppa_hook_mpoa_setup() is called when setting ipoa interface!!!\n"); */
		ppa_hook_mpoa_setup(vcc, 3/* routed */, mode);	//  IPoA, LLC/VC-Mux
    }
	return 0;
}
...
static int clip_mkip(struct atm_vcc *vcc, int timeout)
{
    ...
    {
		/* printk("clip_mkip(): ppa_hook_mpoa_setup() is called when setting ipoa interface!!!\n"); */
		ppa_hook_mpoa_setup(vcc, 3/* routed */, 1/* default llc, will be modified in clip_encap() if vc-mux */);	//  IPoA, LLC
    }
