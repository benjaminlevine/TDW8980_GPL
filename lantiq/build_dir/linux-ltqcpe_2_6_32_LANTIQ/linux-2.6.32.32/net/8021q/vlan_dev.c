		  ...
		  struct packet_type *ptype, struct net_device *orig_dev)
{
	...
	/* 
	 * The switch port is configured with VID 1-4 for port 0-3 in TX, 
	 * and VID 0x801-804 for port 0-3 in RX. vconfig interfaces in the 
	 * stack are only made for VID 1-4 as in eth0.1-eht0.4 --Ritesh 
	 */
