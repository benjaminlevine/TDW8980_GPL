...
PKG_BUILD_BIN_DIR ?= $(PKG_BUILD_DIR)/bin-install
...
ifneq ($(PKG_TYPE),BINARY)
  ...
  $(STAMP_BUILT): $(STAMP_CONFIGURED)
	$$(call Package/unpack/ipkg,$(UNSTRIP_PACKAGE_DIR)/`basename $$(IPKG_$(1))`,$(PKG_BUILD_BIN_DIR))
	touch $$@
