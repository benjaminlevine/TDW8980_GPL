...
# ltq-extensions
$(eval $(call nf_add,IPT_LTQATTACK,CONFIG_IP_NF_MATCH_LTQATTACK,$(P_V4)ipt_ifxattack))
$(eval $(call nf_add,IPT_WEBSTR,CONFIG_IP_NF_MATCH_WEBSTR,$(P_V4)ipt_webstr))
$(eval $(call nf_add,IPT_SYNFLOOD,CONFIG_IP_NF_MATCH_SYNFLOOD,$(P_V4)ipt_synflood))
...
IPT_BUILTIN += $(IPT_LTQATTACK-y)
IPT_BUILTIN += $(IPT_WEBSTR-y)
IPT_BUILTIN += $(IPT_SYNFLOOD-y)
IPT_BUILTIN += $(IPT_TRIGGER-y)
