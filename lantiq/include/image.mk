...
ifneq ($(CONFIG_LINUX_2_4)$(CONFIG_LINUX_2_6_25)$(CONFIG_TARGET_ifxcpe),)
USE_SQUASHFS3 := y
endif
...
ifneq ($(CONFIG_TARGET_ROOTFS_INITRAMFS),y)
  ...
  ifneq ($(CONFIG_TARGET_ifxcpe)$(CONFIG_TARGET_ltqcpe),)
    define Image/mkfs/firmware
	$$(call Image/Build,firmware)
    endef
  endif

  ifneq ($(CONFIG_TARGET_ifxcpe)$(CONFIG_TARGET_ifxmips)$(CONFIG_TARGET_ltqcpe),)
