...
dlna_guess_media_profile (dlna_t *dlna, const char *filename)
{
  ...
  if (!dlna->inited)
	...
	/*±ÈÈç¶ÔÓÚmp3¸ñÊ½µÄÎÄ¼þÊ±ÈçºÎ½âÎöµÄå?µ±DLNA media serverÔö¼ÓÒ»ÖÖÃ½ÌåÀàÐÍÊ±ÐèÒªÌí¼ÓÏàÓ¦µÄ¿âµÄÖ§³Ö,
  ...
  /*Èç¹ûÖ´ÐÐµ½ÕâÀïÔòËµÃ÷ffmpegÕýÈ·µÄ½âÎöÁË¸ÄÀàÐÍµÄÃ½ÌåÎÄ¼þ,ÏÂÃæÐèÒªdlnaÕâÒ»²ãÀ´ÌáÈ¡ºÏÊÊµÄÊý¾Ý·µ»Ø,
    *Added by LI CHENGLONG , 2011-Dec-07.*/
  p = dlna->first_profile;
  while (p)
  {
    dlna_profile_t *prof;
 	...
 	/*Ó¦¸ÃÈ¥µô, Added by LI CHENGLONG , 2011-Dec-07.*/
	/*ÏÈÕÒµ½ºó×ºÃû¶ÔÓ¦µÄprofile, Added by LI CHENGLONG , 2011-Dec-07.*/
	...
	/*Ö±µ½·µ»ØÕýÈ·µÄÐÅÏ¢»òµ½Á´±íÎ², Added by LI CHENGLONG , 2011-Dec-07.*/
